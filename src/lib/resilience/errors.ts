// Vendored from cubiczan-resilience (typescript/src/errors.ts). Do not edit casually;
// keep in sync with the upstream primitive. No npm registry, so this is copied in.
/**
